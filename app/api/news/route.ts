        ...
        const samplesByCategory: { [key: string]: NewsItem[] } = {
          general: [
            ...
            },
            {
              ...
              imageUrl: 'https://images.unsplash.com/photo-1577036421869-7c8d388d2123?w=1200&q=80',
          ...
          breaking: [
            {
              ...
              imageUrl: 'https://images.unsplash.com/photo-1636466497217-26a8cbeaf0aa?w=1200&q=80',
              publishedAt: new Date().toISOString(),
            ...
            },
            {
              ...
              imageUrl: 'https://images.unsplash.com/photo-1534760116381-8b16e2eeb27e?w=1200&q=80',
          ...
          technology: [
            ...
            },
            {
              ...
              imageUrl: 'https://images.unsplash.com/photo-1558346490-a72e53ae2d4f?w=1200&q=80',
              publishedAt: new Date(Date.now() - 1000 * 60 * 60).toISOString(),
              source: 'Network News',
              category: cat,
            },
            {
              ...
              imageUrl: 'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=1200&q=80',
              publishedAt: new Date(Date.now() - 1000 * 60 * 90).toISOString(),
          ...
          science: [
            ...
            },
            {
              ...
              imageUrl: 'https://images.unsplash.com/photo-1579154204845-baf767cf8d66?w=1200&q=80',
              publishedAt: new Date(Date.now() - 1000 * 60 * 30).toISOString(),
          ...
          health: [
            {
              ...
              imageUrl: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=1200&q=80',
              publishedAt: new Date().toISOString(),
            ...
            },
            {
              ...
              imageUrl: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=1200&q=80',
              publishedAt: new Date(Date.now() - 1000 * 60 * 30).toISOString(),
          ...
          sports: [
            ...
            },
            {
              ...
              imageUrl: 'https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?w=1200&q=80',
              publishedAt: new Date(Date.now() - 1000 * 60 * 60).toISOString(),
              source: 'Tennis Today',
              category: cat,
            },
          ...
          entertainment: [
            ...
            },
            {
              ...
              imageUrl: 'https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=1200&q=80',
              publishedAt: new Date(Date.now() - 1000 * 60 * 60).toISOString(),
              source: 'Billboard',
              category: cat,
            },
            {
              ...
              imageUrl: 'https://images.unsplash.com/photo-1574267432644-f610cbb2c7e8?w=1200&q=80',
              publishedAt: new Date(Date.now() - 1000 * 60 * 90).toISOString(),
