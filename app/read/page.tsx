      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <article className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <header className="p-8 pb-6 border-b border-gray-100">
            <a 
              href="/" 
              className="inline-flex items-center text-sm font-semibold text-red-600 hover:text-red-700 mb-6 transition-colors"
            >
              ← Back to News
            </a>
            ...
            <div className="text-sm text-gray-600 flex items-center font-medium">
              ...
              {(source && publishedAt) && <span className="mx-3 text-gray-300">•</span>}
              {publishedAt && (
                <span>
          ...
          {imageUrl && (
            <div className="w-full h-96 bg-gradient-to-br from-gray-100 to-gray-50 overflow-hidden">
          ...
          <div className="p-8 lg:p-12">
            {loading ? (
              <div className="flex items-center justify-center py-12 text-gray-600">
                ...
                <span className="text-lg font-medium">Loading article content…</span>
              </div>
            ) : (
              ...
              <div className="mt-10 pt-8 border-t border-gray-200">
                <div className="flex items-center justify-between bg-gray-50 rounded-xl p-6">
                  ...
                  <a 
                    ...
                    className="px-6 py-3 bg-red-600 text-white font-bold rounded-lg hover:bg-red-700 hover:shadow-lg hover:shadow-red-600/30 transition-all duration-200 active:scale-95 text-sm"
                  >
                    Visit Source →
                  </a>
                </div>
